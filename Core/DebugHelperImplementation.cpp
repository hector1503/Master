...
{
	// DONE: OPCIONAL esto va bién tenerlo escribiendo en un fichero
	OutputDebugString(("LOG: " + text).c_str());
}

void CDebugHelperImplementation::Render()
{
	// DONE: pintar el AntTweakBar
